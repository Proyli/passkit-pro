...
}, [location.key]); // 👈 esto es lo importante
          ...
          <Table>
              ...
              <TableRow className="border-b bg-muted/50">
                ...
                {visibleColumns.id && (
                  ...
                  {visibleColumns.dateOfBirth && (
                    <TableHead className="font-medium text-muted-foreground">BIRTHDATE</TableHead>
                  )}

                  {visibleColumns.clientCode && (
                    <TableHead className="font-medium text-muted-foreground">CLIENT CODE</TableHead>
                  )}

                  {visibleColumns.campaignCode && (
                <TableHead className="font-medium text-muted-foreground">CAMPAIGN CODE</TableHead>
              )}

              <TableHead className="font-medium text-muted-foreground text-right sticky right-0 bg-white z-10">
                ACTIONS
              </TableHead>
            ...
            <TableCell>
             ...
             {visibleColumns.externalId && (
              ...
              {visibleColumns.clientCode && (
                <TableCell>{member.clientCode}</TableCell>
              )}

              {visibleColumns.campaignCode && (
                <TableCell>{member.campaignCode}</TableCell>
              )}

          <TableCell className="text-right sticky right-0 bg-white z-10 w-[150px]">
            <div className="flex justify-end gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
               onClick={() => handleCopyLink(member.externalId)} // 👈 importante usar camelCase
                className="h-8 w-8 p-0 hover:bg-muted"
              >
