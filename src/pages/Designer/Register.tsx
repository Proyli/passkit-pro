...
export default function DesignerRegister() {
  ...
  const addField = () =>
    setCfg(s => ({ ...s, fields: [...s.fields, { name: "", label: "", type: "text", required: false }] }));
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={copyLink}>Share</Button>
          ...
          <Card className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input value={cfg.buttonText} onChange={(e)=>setCfg(s=>({...s,buttonText:e.target.value}))}/>
              </div>
              <div>
                <Label>Primary color</Label>
                <Input value={cfg.primaryColor} onChange={(e)=>setCfg(s=>({...s,primaryColor:e.target.value}))}/>
              </div>
            </div>
                ...
                <div key={i} className="grid grid-cols-12 gap-2 border rounded-lg p-3">
                  <div className="col-span-3">
                    ...
                    <Input value={f.name} onChange={e=>{
                      const v=e.target.value; setCfg(s=>{const a=[...s.fields]; a[i]={...a[i],name:v}; return {...s,fields:a};});
                    }}/>
                  </div>
                  <div className="col-span-5">
                    <Label>Label</Label>
                    <Input value={f.label} onChange={e=>{
                      const v=e.target.value; setCfg(s=>{const a=[...s.fields]; a[i]={...a[i],label:v}; return {...s,fields:a};});
                    }}/>
                  </div>
                  <div className="col-span-2">
                    ...
                    <select
                      ...
                      onChange={e=>{
                        ...
                        setCfg(s=>{const a=[...s.fields]; a[i]={...a[i],type:v}; return {...s,fields:a};});
                      }}
                    >
                    ...
                    <label className="flex items-center gap-2 text-sm">
                      <input
                        ...
                        onChange={e=>{
                          ...
                          setCfg(s=>{const a=[...s.fields]; a[i]={...a[i],required:v}; return {...s,fields:a};});
                        }}
                      />
                      Required
                    </label>
